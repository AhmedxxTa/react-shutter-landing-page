  ...
  return (
    <div className="h-screen ">
      ...
      <div className="w-full max-w-[650px] h-[100%] flex flex-col justify-center items-start text-center text-white px-12">
        ...
        <button className="text-2xl text-white py-4 px-8 mb-10 bg-[#f76d28] border-[2px] border-[#f76d28] rounded-lg transition-[0.2s] ease-in-out hover:bg-[#f76d28] hover:scale-105 active:scale-95 ">Book Now</button>
      </div>
    </div>
  );
};
